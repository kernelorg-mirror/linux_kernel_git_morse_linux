...
functions_to_keep = [
	...
	"rdtgroup_abmc_cfg",
	"resctrl_arch_assign_cntr",
	"resctrl_arch_mbm_cntr_assign_test",
...
functions_to_move = [
	...
	"rdtgroup_rmid_show",
	"rdtgroup_mbm_mode_show",
	"rdtgroup_mbm_cntr_reset",
	"rdtgroup_mbm_mode_write",
	"rdtgroup_num_mbm_cntrs_show",
	"rdtgroup_mon_state_to_str",
	"rdtgroup_mbm_control_show",
	"rdtgroup_assign_update",
	"rdtgroup_unassign_update",
	"rdtgroup_str_to_mon_state",
	"rdtgroup_find_grp",
	"rdtgroup_process_flags",
	"rdtgroup_mbm_control_write",
	"proc_resctrl_show",
