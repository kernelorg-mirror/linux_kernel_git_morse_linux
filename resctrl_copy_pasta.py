...
functions_to_keep = [
	...
	"rdt_ctrl_update",
	"resctrl_arch_mbm_cntr_assign_enabled",
	"domain_init",
...
functions_to_move = [
	...
	"resctrl_assign_cntr_event",
	"resctrl_free_config_cntr",
	"resctrl_unassign_cntr_event",
	"mbm_cntr_reset",
	...
	"rdtgroup_rmid_show",
	"resctrl_mbm_assign_mode_show",
	"resctrl_num_mbm_cntrs_show",
	"resctrl_available_mbm_cntrs_show",
	"resctrl_mbm_assign_mode_write",
	"rdtgroup_mon_state_to_str",
	"resctrl_mbm_assign_control_show",
	"resctrl_str_to_mon_state",
	"rdtgroup_find_grp_by_name",
	"resctrl_process_flags",
	"resctrl_mbm_assign_control_write",
	"proc_resctrl_show",
